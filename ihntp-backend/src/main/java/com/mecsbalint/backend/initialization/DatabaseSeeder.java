...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        game1.setTags(List.of(tag1, tag2, tag3, tag4));
        game1.setDevelopers(List.of(dev1));
        game1.setPublishers(List.of(pub1));
        ...
        game2.setTags(List.of(tag5, tag6, tag3, tag4));
        game2.setDevelopers(List.of(dev2));
        game2.setPublishers(List.of(pub2));
        ...
        game3.setTags(List.of(tag6, tag3, tag9, tag4));
        game3.setDevelopers(List.of(dev3));
        game3.setPublishers(List.of(pub4));
        game3.setScreenshots(List.of(
        ...
        game4.setTags(List.of(tag7, tag9, tag3, tag4));
        game4.setDevelopers(List.of(dev3));
        game4.setPublishers(List.of(pub3));
        game4.setScreenshots(List.of(
        ...
        game5.setTags(List.of(tag7, tag9, tag3, tag11));
        game5.setDevelopers(List.of(dev3));
        game5.setPublishers(List.of(pub3));
        game5.setScreenshots(List.of(
        ...
        game6.setTags(List.of(tag8, tag3, tag9, tag4));
        game6.setDevelopers(List.of(dev6, dev7, dev8));
        game6.setPublishers(List.of(pub4));
        game6.setScreenshots(List.of(
        ...
        game7.setTags(List.of(tag7, tag11, tag12, tag9));
        game7.setDevelopers(List.of(dev3));
        game7.setPublishers(List.of(pub4));
        game7.setScreenshots(List.of(
        ...
        game8.setTags(List.of(tag3, tag9, tag10, tag12));
        game8.setDevelopers(List.of(dev5)); // Add developer if available
        game8.setPublishers(List.of(pub6)); // Add publisher if needed
        game8.setScreenshots(List.of(
        ...
        game9.setTags(List.of(tag3, tag10, tag12, tag9));
        game9.setDevelopers(List.of(dev4));
        game9.setPublishers(List.of(pub5));
        game9.setScreenshots(List.of(
        ...
        game10.setTags(List.of(tag3, tag10, tag12, tag9));
        game10.setDevelopers(List.of(dev4));
        game10.setPublishers(List.of(pub5));
        game10.setScreenshots(List.of(
