        ...
        <dialog id={modalId} className="modal">
            <div className="modal-box w-fit">
                <div className="fieldset w-xs">
                    ...
                    <input type="text" className="input" value={link} onChange={event => handleOnChange(event)} onKeyUp={event => event.keyCode === 13 && link.length > 0 && validationStatus && handleAddBtnClick()}></input>
